#!/usr/bin/env python3
"""
Dash Cam Viewer YOLO v2 - Roadside Post Detection + Vehicle Marker Map
Extends v1: vehicle detections shown as individual colored markers per class.
"""
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        for btn in [self.process_btn, self.view_btn_side, self.review_btn, self.vehicles_btn]:
